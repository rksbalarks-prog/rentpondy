  ...
  return (
    ...
    <div className='box'>
      <div className='inner1'>
          ...
          <button className='btt' onClick={() => setLimit(5)}>5</button>
          <button className='btt' onClick={() => setLimit(20)}>20</button>

        {/* {loopLimits.map((limit) => (
          <button className='btt' onClick={() => setLimit(20)}>
