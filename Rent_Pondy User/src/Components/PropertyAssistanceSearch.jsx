...
import {FaPhoneAlt, FaRulerCombined,  FaBath, FaChartArea, FaPhone ,FaEdit,FaRoad,FaCreditCard,FaLandmark, FaHome, FaUserAlt, FaEnvelope,  FaRupeeSign , FaFileVideo , FaToilet,FaCar,FaBed,  FaCity , FaTimes, FaArrowRight, FaStreetView, FaSearch, FaChevronLeft} from 'react-icons/fa';
...
const navigate = useNavigate();
 ...
 const handleInputChanges = (e) => {
  ...
  return (
    ...
    style={{
      ...
      fontFamily: 'Inter, sans-serif'
       ...
       >
         ...
          </button> <h3 className="m-0" style={{fontSize:"18px"}}>Tenant Assistance</h3> </div>
   ...
   >view Tenant List</button>
      ...
      <h4 className="form-title mt-2" style={{color: '#4F4B7E', fontSize:"15px", fontWeight:"bold"}}>Tenant Assistance</h4>
 ...
 <div className="row mb-3 justify-content-around">
  ...
  {/* <div className="col-5 p-0">
        <label style={{fontWeight:600}}>Min Price <span style={{ color: 'red' }}>* </span></label>

    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",fontSize:"14px"}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("minPrice")}>
...
>   
        ...
        >
           Select or Search <span style={{color:"black"}}>minPrice</span>
        </div>
<div
              style={{
              position: 'relative',
...
>    
 ...
 <input 
      ...
      outline: "none",
        ...
        <ul className="list-group mt-2 w-100"     style={{
                listStyleType: 'none',
                padding: 0,
                margin: 0,
                    overflowY: 'auto',
...
<div className="form-group col-5 p-0 m-0" >
  ...
  {/* <div className="col-5 p-0">
        <label  style={{fontWeight:600}}>Max Price<span style={{ color: 'red' }}>* </span></label>

    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",fontSize:"14px"}}
...
>       
        ...
        >
           Select or Search <span style={{color:"black"}}>maxPrice</span>
        </div>
<div
              style={{
                 position: 'relative',
...
<div className="row justify-content-center">
  {/* <div className="col-12 mb-3">
    <label  style={{fontWeight:600}}>Property Mode <span style={{ color: 'red' }}>* </span></label>
    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("propertyMode")}>
...
<div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Property Mode</span>
        </div>
...
<div className="row">
  {/* Property Type */}
  {/* <div className="col-12 mb-3">
        <label  style={{fontWeight:600}}>Property Type <span style={{ color: 'red' }}>* </span></label>

    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("propertyType")}>
...
>   
        ...
        >
           Select or Search <span style={{color:"black"}}>Property Type</span>
        </div>
<div
              style={{
              position: 'relative',
...
<label>Property Type <span style={{ color: 'red' }}>* </span> </label>
  ...
  <div className="form-group" >
   ...
   {/* Bed */}
   {/* <div className="col-12 mb-3">
    <label  style={{fontWeight:600}}>Bed</label>
    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("bedrooms")}>
...
<div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Bedrooms</span>
        </div>
<div
              style={{
              position: 'relative',
...
<div className="form-group">
 ...
 {/* <div className="col-12 mb-3">
  <label  style={{fontWeight:600}}>Facing</label>
    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("facing")}>
...
<div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Facing</span>
        </div>
<div
              style={{
              position: 'relative',
...
onClick={() => handleDropdownSelect("facing", option)}>
  ...
  <div className="form-group">
    ...
    {/* Property Approved */}
    {/* <div className="col-12 mb-3">
      <label  style={{fontWeight:600}}>Property Approved</label>
    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}}
...
>       
  ...
  <div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Property Approved</span>
        </div>
<div
              style={{
              position: 'relative',
...
{/* Property Age */}
{/* <div className="col-12 mb-3">
  <label  style={{fontWeight:600}}>Propertry Age</label>
  <div className="input-group">
    <button
      type="button"
    ...
    >
      <span >
        <FaCheckCircle className="me-2" color="#4F4B7E" /> {formData.propertyAge || "Select Property Age"}
      </span>
      <FaChevronDown color="#4F4B7E" />
    </button>
  </div>
...
<div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Propertry Age</span>
        </div>
<div
              style={{
              position: 'relative',
...
>    
 ...
 <input 
  ...
  {/* Bank Loan */}
  {/* <div className="col-12 mb-3">
    <label  style={{fontWeight:600}}>Bank Loan</label>
    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("bankLoan")}>
...
>       
 <div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Bank Loan</span>
        </div>
<div
              style={{
              position: 'relative',
...
{/* Area Unit Dropdown */}
{/* <div className="col-12 mb-3">
  <label  style={{fontWeight:600}}>Area Unit</label>
  <div className="input-group">
    <button type="button" style={{ border: "1px solid #4F4B7E" }} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("areaUnit")}>
...
>     
 <div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Area Unit</span>
        </div>
<div
              style={{
              position: 'relative',
...
>    
 ...
 <input 
  ...
  {/* Payment Type */}
    {/* <div className="col-12 mb-3">
      <label  style={{fontWeight:600}}>Payment Type</label>
      <div className="input-group">
        <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("paymentType")}>
          <span><FaCreditCard className="me-2" color="#4F4B7E" /> {formData.paymentType || "Select paymentType"}</span> 
          <FaChevronDown color="#4F4B7E"/>
        </button>
      </div>
...
<div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>Payment Type</span>
        </div>
<div
              style={{
              position: 'relative',
      ...
      style={{
            ...
            {(dataList.paymentType || []).filter(option => option.toLowerCase().includes(dropdownState.filterText.toLowerCase())).map((option, index) => (
              <li key={index}      style={{
                  ...
                  //  className="list-group-item list-group-item-action d-flex align-items-center"
                    onClick={() => handleDropdownSelect("paymentType", option)}>
                 {option}
              </li>
            ))}
          </ul>
...
{/* <div className="col-12 mb-3">
      <label  style={{fontWeight:600}}>State <span style={{ color: 'red' }}>* </span></label>

    <div className="input-group">
      <button type="button" style={{border: "1px solid #4F4B7E",}} className="btn w-100 d-flex justify-content-between align-items-center m-0 text-muted" onClick={() => toggleDropdown("state")}>
...
>   
  <div className="p-1"
        ...
        >
           Select or Search <span style={{color:"black"}}>State</span>
        </div>
<div
              style={{
              position: 'relative',
