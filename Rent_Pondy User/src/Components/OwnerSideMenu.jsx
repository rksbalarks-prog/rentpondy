...
useEffect(() => {
  const fetchInterestBuyersCount = async () => {
    ...
    try {
      ...
      console.error("Failed to fetch interest Tenant count:", error);
      setInterestBuyersCount(0);
    } finally {
      setLoading(false);
    }
...
useEffect(() => {
  const fetchBuyerAssistViewCount = async () => {
    try {
      ...
      console.error("Failed to fetch Tenant assist view count.");
    }
  };
...
useEffect(() => {
  const fetchContactOwnerCount = async () => {
    try {
      ...
      console.error("Failed to fetch contact Tenant count:", error);
...
useEffect(() => {
  const fetchBuyerPhotoRequestCount = async () => {
    try {
      ...
      console.error("Failed to fetch Tenant photo request count.");
    }
  };
...
useEffect(() => {
  const fetchBuyerOfferCount = async () => {
    try {
      ...
      console.error("Failed to fetch Tenant offer count.");
    }
  };
...
useEffect(() => {
 ...
 fontFamily: "Inter, sans-serif",
  ...
  >
    ...
    <h3 className="m-0">Owner Menu</h3>
  </div>
  ...
  <MenuLink 
        ...
        />
          ...
          <MenuLink  
            ...
            label=" Address Requested Buyers"
