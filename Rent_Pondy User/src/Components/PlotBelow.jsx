...
// export default function PlotBelow() {
//   return (
//     <div>PlotBelow</div>
//   )
// }
...
const formatPrice = (price) => {
 ...
 const filteredProperties = properties.filter((property) => property.propertyType === 'Plot' && property.price < 1500000);
   ...
   return (
     <div className="container d-flex align-items-center justify-content-center p-0">
      ...
      <div className="d-flex align-items-center justify-content-start w-100 p-2"      style={{
           ...
           >
             <FaChevronLeft
              style={{ color: '#4F4B7E', transition: 'color 0.3s ease-in-out' , background:"transparent"}} />
             </button>  
         
         <h3 className="m-0 ms-3" style={{fontSize:"20px"}}>Plot Below 15L </h3> </div>
