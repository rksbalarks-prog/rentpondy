    ...
    const recordDashboardView = async () => {
      try {
        await axios.post(`${process.env.REACT_APP_API_URL}/record-views`, {
          ...
          viewedFile: "My Most Viewed Property",
...
//   try {
//     const response = await axios.get(`${process.env.REACT_APP_API_URL}/user-most-viewed-properties-rent/${phoneNumber}`);
...
const fetchLastViewed = async () => {
  try {
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/user-most-viewed-properties-rent/${phoneNumber}`
    );
    ...
    console.error("Failed to fetch/enrich most viewed rent properties:", err);
  } finally {
    setLoading(false);
  }
};
    ...
    <div className="container d-flex align-items-center justify-content-center p-0">
      <div className="d-flex flex-column align-items-center justify-content-center w-100" style={{ maxWidth: "500px", margin: "auto" }}>
          ...
          >
            ...
            </button>          <h3 className="m-0 ms-3" style={{ fontSize: "20px" }}>My Most Viewed Property</h3>
        </div>
