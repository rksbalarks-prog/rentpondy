...
// export default function PropertyLand() {
//   return (
//     <div>PropertyLand</div>
//   )
// }
...
const PropertyLand = ({phoneNumber}) => {
...
const formatPrice = (price) => {
 ...
 const filteredProperties = properties.filter((property) => property.propertyType === 'Agricultural Land');
  ...
  const handleCardClick = (rentId, phoneNumber) => {
   ...
   <div className="d-flex align-items-center justify-content-start w-100 p-2"      style={{
        ...
        >
         ...
         <h3 className="m-0 ms-3" style={{fontSize:"20px"}}>Agricultural Land</h3> </div>
