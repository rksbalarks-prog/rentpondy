...
<h2 className="text-xl font-bold mb-4">Individual user Login History</h2>
    {/* Filter Section */}
  ...
  backgroundColor: '#fff' 
    ...
    {viewType === 'perDay' && (filteredData || data) && (
      <div className="mt-3">
        <table className="table table-bordered table-striped">
          ...
          <tbody>
            <tr>
              <td><PhoneCell phone={(filteredData || data).phone} /></td>
    ...
    {viewType === 'everyDay' && (filteredData || data) && (
      <div className="mt-3">
        <h5>Phone: <PhoneCell phone={(filteredData || data).phone} /></h5>
