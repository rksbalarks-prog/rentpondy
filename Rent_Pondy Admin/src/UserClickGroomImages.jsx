...
const GroomImageClickTable = () => {
  ...
  const fetchImageClicks = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_API_URL}/get-image-clicks-groom`);
...
return (
  <div className="container mt-4">
    <h3 className="mb-4">Groom Image Click Records</h3>
  ...
  Print
    ...
    {/* 📊 Table Section Card */}
    <div className="card">
      <div className="card-header text-primary fs-5">
        <strong>Click Groom Records</strong>
      </div>
      <div className="card-body">
        {loading ? (
...
export default GroomImageClickTable;
