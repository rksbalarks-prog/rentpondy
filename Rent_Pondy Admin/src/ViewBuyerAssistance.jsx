  ...
  useEffect(() => {
    if (ba_id) {
      axios
        ...
        .catch((error) => {
          setError('Failed to load Tentant Assistance data.');
          setLoading(false);
        });
    }
  }, [ba_id]);
...
    </button> <h3 className="m-0 ms-3" style={{fontSize:"15px", fontWeight:"bold"}}>DETAILED TENTANT ASSISTANT</h3> </div>
  ...
  <div style={{ margin: "10px 0", color: message.type === "error" ? "red" : "green" }}>
    {message.text}
       ...
       <div className='d-flex algin-item-center justify-content-center w-100' style={{height:"200px"}}>
        ...
        <h5 className='ps-3 ms-3' style={{ color: "#30747F", fontWeight: "bold", marginBottom: "10px", fontSize:"15px" }}>Tentant Profile</h5>   
